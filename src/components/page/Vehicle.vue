  ...
  <div class="table">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 车辆审核</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <el-row :gutter="20">
      <el-col :span="16">
        <div class="container">
          ...
          <el-table :data="tableData" border style="font-size: 14px;">
            ...
            <el-table-column prop="brand" show-overflow-tooltip label="车辆品牌" width="150"></el-table-column>
      ...
      <el-col :span="8">
        <div class="container" v-if="edit">
          <el-row  >
            <el-col>
              <h2 style="margin-bottom: 10px">车辆</h2>
              <el-card :body-style="{ padding: '0px',marginTop:'10px'}">
                <img :src="form.cPicture" class="image">
                  ...
                  <div class="vehicle-form">
                    ...
                    <el-row>
                      <el-col :span="12" class="vehicle-form-brand">
                        确认对方车辆型号：
                      </el-col>
                      <el-col :span="10">
                    ...
                    <el-row>
                      <el-col :span="12" class="vehicle-form-licensePlate">
                        填写对方牌照(如浙A)：
                      </el-col>
                      <el-col :span="10">
...
<script>
  ...
  import { getCertificateVehicle,vehicleState,vehicleStateReject} from "../../assets/api/global_request";
  ...
  export default{
    ...
    methods:{
      ...
      requestCertificate(){
       let obj=this;
        let auditFlag=3;
        getCertificateVehicle(auditFlag, this.page.pageCurrent, this.page.pageSize)
          .then(function (data) {
            var data_=data;
            ...
            for(let i = 0;i < data.result.list.length;i++){
                  let json = {
                    ...
                    "brand":data_.result.list[i].brand,
      ...
      handle(type){
       const item = this.tableData[this.idx];
        ...
        let id=item.pkId;
        if (type === 1) {
          vehicleState(id,1,obj.form.licensePlate,obj.form.brand)
            .then(function (data) {
          ...
          vehicleStateReject(id,2,obj.form.licensePlate)
            .then(function (data) {
       ...
       /*console.log("车型测试："+this.form.licensePlate);
        console.log("牌照测试"+this.form.brand);*/
      },
